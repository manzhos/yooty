<template>
    <div class="container">
        ...
        <div class="position-relative">
            ...
            <form class="form-vertical input-form" v-bind:action="path" method="post" role="form" enctype="multipart/form-data" >
                ...
                <div class="row align-items-end">
                    <div class="col-md-7">
                        ...
                        <div class="d-block" style="padding: 2vw;">
                            ...
                            <div class="d-inline-block position-relative vert-top" style="margin-top: 20px; z-index: 20">
                                <div class="title-select" @click="optionsVisibleScience = !optionsVisibleScience">
                                    <div v-for="option_science in options_science">
                                        <span v-if="option_science.id === old_science_id">{{option_science.science_name}}</span>
                                    </div>
                                ...
                                <div class="options-select" v-show="optionsVisibleScience">
                                    <div v-for="option_science in options_science" @click="selectOptionScience(option_science)">
                                        <input v-if="option_science.id === old_science_id" checked
                                               name="science" hidden
                                               v-bind:id="'science_'+option_science.id" type="radio"
                                               v-bind:value="option_science.id" />
                                        <input v-else unchecked
                                               name="science" hidden
                                               v-bind:id="'science_'+option_science.id" type="radio"
                                               v-bind:value="option_science.id" />
                            ...
                            <div class="d-inline-block position-relative vert-top" style="margin-top: 20px; z-index: 10">
                                <div class="title-select" @click="optionsVisibleEducation = !optionsVisibleEducation">
                                    <div v-for="option_education in options_education">
                                        <span v-if="option_education.id === old_education_id">{{option_education.education}}</span>
                                    </div>
                                    <div class="select_icon"><i class="fas fa-chevron-down"></i></div>
                                </div>
                                <div class="options-select" v-show="optionsVisibleEducation">
                                    <div v-for="option_education in options_education" @click="selectOptionEducation(option_education)">
                                        <input v-if="option_education.id === old_education_id" checked
                                               name="education" hidden v-bind:id="'education_'+option_education.id" type="radio" v-bind:value="option_education.id" />
                                        <input v-else unchecked
                                               name="education" hidden v-bind:id="'education_'+option_education.id" type="radio" v-bind:value="option_education.id" />
                        ...
                        <div>
                            ...
                            <input name="subject" id="subject" class="form-control" v-bind:placeholder="old_subject" v-bind:value="old_subject">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="message" id="message" class="form-control-textarea" v-model="message" v-bind:placeholder="old_message">{{ message }}</textarea>
                        </div>
                    </div>
...
<script>
    export default {
        ...
        mounted() {
            ...
            this.path = '/messages/update/' + this.m_id;

            this.message = this.old_message;
