<template>
    <div class="container zero">
        ...
        <div v-if="terminate === 0" class="send-comment-body">
            <div class="w-100 conv-send position-relative">
                ...
                <div class="block-type-send-comment d-inline-block">
                    ...
                    <!-- sending comment -->
                    <div class="position-absolute" style="top: 0; right: 0;" data-tooltip="Utilisez Ctrl(Cmd)+Enter pour envoyer le message.">
        ...
        <div v-else class="send-comment-body">
            <div class="w-100 conv-send position-relative">
...
<script>
    export default {
        ...
        updated() {
            var container = this.$el.querySelector("#conv-body");
